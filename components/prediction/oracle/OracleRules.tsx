        ...
        <Tabs defaultValue="rules">
          ...
          >
            <p>
              ...
              otherwise. Vertical ranges pay out when settlement lands inside the
              chosen band <span className="font-mono">(lower, higher]</span>.
            </p>
            <p>
              Prices derive from the on-chain SVI volatility surface — there is
              no order book. The protocol&apos;s PLP vault quotes and takes the
              other side of every trade, so a contract&apos;s price tracks its
              implied probability plus a small spread.
            </p>
            <p>
              Settlement is fixed by the first post-expiry price push to the
              oracle on DeepBook Predict and is final once recorded on-chain.
              Quote &amp; settlement asset:{" "}
              <span className="font-medium text-foreground">dUSDC</span>{" "}
              (testnet).
            </p>
          </TabsContent>
